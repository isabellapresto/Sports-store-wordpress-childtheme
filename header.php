...
<!-- Template owerwrite  -->
<?php echo "Dagens datum: "?>

<!-- EGET PLUGIN - I mitt egna plugin har jag lagt till en shortcode för att visa dagens datum 
- [dagensdatum] kommer visa aktuellt datum -->
<?php echo do_shortcode('[dagensdatum]'); ?>
